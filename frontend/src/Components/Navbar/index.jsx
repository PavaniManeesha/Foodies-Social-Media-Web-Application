...
import LogoImage from "../../assets/FoodCitricLogo.png";
      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light p-3">
        <div className="container-fluid">
          ...
          <div className="d-flex">
              <input type="text" placeholder="Looking for..." className="form-control me-2" />
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            {user.loginStatus && (
              <>
                <div className="d-flex">
                <Link className="nav-link me-2 text-dark" to="/" style={{fontWeight: "bold",fontFamily: "serif"}}>
                    Feed
                  </Link>
                  <Link className="nav-link me-2 text-dark" to="/user" style={{fontWeight: "bold",fontFamily: "serif"}}>
                    Posts
                  </Link>
                  <Link
                    onClick={() => {
